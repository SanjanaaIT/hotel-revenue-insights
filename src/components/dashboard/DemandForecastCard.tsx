...
export const DemandForecastCard = () => {
  const currentDemand = demandLevels[demandForecast.level];
            ...
            <div className="rounded-lg bg-secondary/50 p-3">
              ...
              <p
                className={cn(
                  ...
                  demandLevels[demandForecast.nextWeek].color
                )}
              >
                {demandForecast.nextWeek}
              </p>
            </div>
            <div className="rounded-lg bg-secondary/50 p-3">
              ...
              <p
                className={cn(
                  "text-sm font-semibold capitalize",
                  demandLevels[demandForecast.nextMonth].color
                )}
              >
                {demandForecast.nextMonth}
              </p>
            </div>
          </div>
        </div>
